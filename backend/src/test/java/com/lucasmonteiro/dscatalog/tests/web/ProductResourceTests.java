package com.lucasmonteiro.dscatalog.tests.web;
...
public class ProductResourceTests {
	...
	@Test
	public void insertShouldReturnCreatedAndCreatedProductWhenValidData() throws Exception {
	...
	// Essa função irá fazer um acesso na api e vai retornar uma String que é o token
