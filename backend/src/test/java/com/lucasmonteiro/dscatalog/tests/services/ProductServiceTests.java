package com.lucasmonteiro.dscatalog.tests.services;
...
public class ProductServiceTests {
	...
	public void deleteShouldDoNothingWhenIdExists() {
		...
		Mockito.verify(repository, Mockito.times(1)).deleteById(existingId); // verify() -> Vai verificar se alguma chamada foi feita
